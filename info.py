...
PICS = (environ.get('PICS' ,'https://telegra.ph/file/c1f2dd8daad40b4736d1a.jpg')).split()
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Mr_Abnormal")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Mr_Abnormal')
